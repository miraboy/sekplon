                ...
                <div class="col-lg-8">
                    ...
                    <div class="row g-4 mt-4">
                        <div class="col-md-4 text-center" data-aos="fade-up" data-aos-delay="100">
                            <div class="card p-3">
                                ...
                                <p class="mb-0">
                                    <a href="mailto:contact@sekplon.com" title="Envoyer un email à Mirabel" aria-label="Envoyer un email à Mirabel" style="text-decoration:none;color:inherit;">
                                        contact@sekplon.com
                                    </a>
                                </p>
                                <p class="mb-0">
                                    <a href="mailto:mirabelbarryl@gmail.com" title="Envoyer un email à Mirabel" aria-label="Envoyer un email à Mirabel" style="text-decoration:none;color:inherit;">
                                        mirabelbarryl@gmail.com
                                    </a>
                                </p>
                            </div>
                        </div>
                        <div class="col-md-4 text-center" data-aos="fade-up" data-aos-delay="200">
                            <div class="card p-3">
                                ...
                                <p class="mb-0">
                                    <a href="tel:+2290152685298" title="Appeler Mirabel" aria-label="Appeler Mirabel" style="text-decoration:none;">
                                        +229 01 52 68 52 98
                                    </a><br>
                                    <a href="tel:+2290140265683" title="Appeler Mirabel" aria-label="Appeler Mirabel" style="text-decoration:none;">
                                        +229 01 40 26 56 83
                                    </a>
                                </p>
                            </div>
                    ...
                    <div class="text-center mt-4">
                        <div class="social-links">
                            ...
                            <a href="mailto:contact@sekplon.com.com" title="Email"><i class="bi bi-envelope"></i></a>
